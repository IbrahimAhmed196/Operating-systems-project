...
public class FXMLDocumentController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        schedulerType.getItems().removeAll(schedulerType.getItems());
        schedulerType.getItems().addAll("FCFS", "SJF(Preemptive)", "SJF(Non Preemptive)",
                "Priority(Preemptive)","Priority(non Preemptive)", "Round Robin");
        schedulerType.getSelectionModel().select("Priority(Preemptive)");
